...
if __name__ == '__main__':
    ...
    Servo7 = MG90_96R_Class(Channel = 0, ZeroOffset = -10)
    Servo8 = MG90_96R_Class(Channel = 0, ZeroOffset = -10)
    Servo9 = MG90_96R_Class(Channel = 0, ZeroOffset = -10)
    Servo10 = MG90_96R_Class(Channel = 0, ZeroOffset = -10)
